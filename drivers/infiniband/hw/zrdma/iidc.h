...
#define ZXDH_RDMA_DEVICE_VALID 1

#define ZXDH_NET_MAJOR_IDX GENMASK_ULL(7, 0)
#define ZXDH_NET_MINOR_IDX GENMASK_ULL(15, 8)
#define ZXDH_RDMA_MINOR_IDX GENMASK_ULL(23, 16)
#define ZXDH_RDMA_COMM_FUNC BIT_ULL(24)
#define ZXDH_RDMA_DEVICE_STA BIT_ULL(25)
#define ZXDH_HIGH_25BIT_MAP 25
...
struct zxdh_auxiliary_dev {
	...
	void *parent;
	int32_t aux_id;
	void *auxiliary_ops[18]; //max support 20 auxiliary devices
};
...
struct iidc_auxiliary_drv {
	struct zxdh_auxiliary_driver adrv;
